...
namespace LM.Data.Migrations
{
    ...
    [Migration("20200615022708_AddedDefaultDaysandPeriod")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LM.Data.LeaveAllocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LM.Data.LeaveHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LM.Data.LeaveType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LM.Data.Employee", b =>
                {
            ...
            modelBuilder.Entity("LM.Data.LeaveAllocation", b =>
                {
                    b.HasOne("LM.Data.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId");

                    b.HasOne("LM.Data.LeaveType", "Type")
                        .WithMany()
            ...
            modelBuilder.Entity("LM.Data.LeaveHistory", b =>
                {
                    b.HasOne("LM.Data.Employee", "ApprovedBy")
                        .WithMany()
                        .HasForeignKey("ApprovedById");

                    b.HasOne("LM.Data.LeaveType", "LeaveType")
                        .WithMany()
                        .HasForeignKey("LeaveTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LM.Data.Employee", "RequestingEmployee")
                        .WithMany()
